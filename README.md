...
- 使用 GoatCounter 记录匿名访问量和页面访问情况；统计仅在维护后台查看，不在页面公开展示，也不使用 Cookie。
...
网站使用 [GoatCounter](https://www.goatcounter.com/) 的无 Cookie 统计代码，统计首页、404 备用入口和每篇独立文章页的匿名访问情况。数据保存在 GoatCounter 后台，仅供网站维护使用；网站不在页面显示累计访问数字。
